...
/**
 * Detect country from request headers (Vercel geo headers)
...
export function detectCountryFromHeaders(headers: Headers): string | null {
  ...
  // Fallback: try Cloudflare headers if available
...
/**
 * List of common countries for selection dropdown
 */
 ...
 * @returns Array of country codes and names
 */
